...
namespace TAT
{
    public partial class frmCreditAnalystApplicationSelect : System.Web.UI.Page
    {
        ...
        {
            string sqlString = "Exec creditRiskApplicationSelect " + int.Parse(Session["userID"].ToString()) + ", " + int.Parse(Session["applicationId"].ToString());
            try
            {
                db.openConnection();
        ...
        {
            clsGlobal.sqlString = "Exec CreditRiskApprovedApplications " + int.Parse(Session["applicationId"].ToString()) + ", " + int.Parse(Session["userID"].ToString()) + ", '" + txtReason.Text + "','" + "2012-02-08" + "', '" + "Approved" + "'";
            try
            {
                db.openConnection();
        ...
        {
            clsGlobal.sqlString = "Exec CreditRiskApprovedApplications " + int.Parse(Session["applicationId"].ToString()) + ", " + int.Parse(Session["userID"].ToString()) + ", '" + txtReason.Text + "','" + "2012-02-08" + "', '" + "Rejected" + "'";
            try
            {
                db.openConnection();
                db.comm.CommandText = clsGlobal.sqlString;
