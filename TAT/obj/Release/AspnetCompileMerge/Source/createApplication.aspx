                    ...
                    <asp:Panel ID="panelMortage" runat="server" >
                        ...
                        <asp:Panel ID="PanelParticularsOne" runat="server" Visible="false">
                                ...
                                <div class="row">
                                    <br />
                                    <div class="col-md-5">
                                        <asp:Label ID="Label21" runat="server" Text=" State name . if applicable" CssClass="lables"></asp:Label>
                                    </div>
                                    <div class="col-md-3">
                                        <asp:TextBox ID="txtStateName" runat="server" CssClass="form-control" Width="100%"></asp:TextBox>
                                    </div>
                                </div>
                            <div class="row">
                                    <br />
                                    <div class="col-md-5">
                                        <asp:Label ID="Label36" runat="server" Text=" Number. if applicable" CssClass="lables"></asp:Label>
                                    </div>
                                    <div class="col-md-3">
                            ...
                            <div class ="row">
                             ...
                             <div class="row">
                              ...
                              <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-9">
                                        <asp:Label ID="Label26" runat="server" Text="Indicate sources to meer shortfall between purchases/cost and Loan Amount" Font-Bold="true"></asp:Label>
                                    </div>
                                </div>
                        ...
                        <asp:Panel ID="PanelParticularsThree" runat="server" Visible="true">
                             ...
                             <div class="row">
                                ...
                                <div class="col-md-5 col-lg-offset-1">
                                 ...
                                 <div class="col-md-3">
                                   ...
                                   <asp:FileUpload ID="FileUploadEvaluation" runat="server" />
                                </div>
                                 <div class="col-md-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <asp:TextBox ID="txtIsThePropertyMortagaged" runat="server" CssClass="form-control" Width="100%" ></asp:TextBox>
                                </div>
                            ...
                            <div class="row">
                             ...
                             <div class="row">
                                ...
                                <div class="col-md-3">
                                    <asp:TextBox ID="txtPropertyGuestHouse" runat="server" CssClass="form-control" Width="100%" ></asp:TextBox>
                                </div>
