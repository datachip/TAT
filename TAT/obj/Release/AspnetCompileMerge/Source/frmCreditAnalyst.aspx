<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmCreditAnalyst.aspx.cs" Inherits="TAT.frmCreditAnalyst" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="templatemo-content-container col-md-10 col-md-offset-1">
            ...
            <div class="templatemo-content-widget white-bg">
                <h2 class="margin-bottom-10">Credit Analyst </h2>
                ...
                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <asp:Button ID="cmdSearch2" runat="server" Text="Search" CssClass="templatemo-edit-btn" ToolTip="Search by ID" OnClick="cmdSearch2_Click"/>
                        </div>
                    </div>
                    <!------>
