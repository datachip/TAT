<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmCreditAnalystApplicationSelect.aspx.cs" Inherits="TAT.frmCreditAnalystApplicationSelect1" %>
        ...
        <div class="templatemo-content-container col-md-10 col-md-offset-1">
            ...
            <div class="templatemo-content-widget white-bg">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <asp:Button ID="cmdSubmit" runat="server" Text="Submit" CssClass="templatemo-edit-btn" Width="100%" OnClick="cmdSubmit_Click" />
                    </div>
                    <div class="col-md-3">
                        <asp:Button ID="cmdReject" runat="server" Text="Reject" CssClass="templatemo-edit-btn" Width="100%" OnClick="cmdReject_Click" />
                    </div>
                        </div>
                </div>
