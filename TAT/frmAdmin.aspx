...
<%@ Register Src="~/userControlUsers.ascx" TagName="ucUsers" TagPrefix="users" %>
<%@ Register Src="~/ucDepartments.ascx" TagName="ucDepartments" TagPrefix="departments" %>
<%--<%@ Register Src="~/ucBranches.ascx" TagName="ucBranches" TagPrefix="branches" %>--%>
                ...
                <div class="row">
                                ...
                                <div id="related-act-inner">
                                    <div class="right">
                                        ...
                                        <ul class="greyarrow">
                                            ...
                                            <li><asp:LinkButton ID="lnkEditUser" runat="server" ToolTip="Add User" OnClick="lnkEditUser_Click">Edit</asp:LinkButton></li>
                                    ...
                                    <div class="right">
                                        ...
                                        <ul class="greyarrow">
                                            <li>
                                                <asp:LinkButton ID="lnkAddBranch" runat="server" ToolTip="Add Branch" OnClick="lnkAddBranch_Click">Add</asp:LinkButton></li>
                                            <li>
                                                <asp:LinkButton ID="lnkManageBranch" runat="server" ToolTip="Manage Branch" OnClick="lnkManageBranch_Click">Edit</asp:LinkButton></li>
                                            <li>
                                                <asp:LinkButton ID="lnkListBranches" runat="server" ToolTip="List All Branches" OnClick="lnkListBranches_Click">List</asp:LinkButton></li>
                                            <li>
                                                <asp:LinkButton ID="lnkDeleteBranch" runat="server" ToolTip="Delete a Branch" OnClick="lnkDeleteBranch_Click">Delete</asp:LinkButton></li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="right">
                                        <h5>Departments </h5>
                                        <ul class="greyarrow">
                                            <li><asp:LinkButton ID="lnkAddDepartment" runat="server" ToolTip="Add Department" OnClick="lnkAddDepartment_Click">Add</asp:LinkButton></li>
                                            <li><asp:LinkButton ID="lnkEditDepartment" runat="server" ToolTip="Edit Department" OnClick="lnkEditDepartment_Click">Edit</asp:LinkButton></li>
                                            <li><asp:LinkButton ID="lnkListDepartment" runat="server" ToolTip="List Department" OnClick="lnkListDepartment_Click">List</asp:LinkButton></li>
                                            <li><asp:LinkButton ID="lnkDeleteDepartment" runat="server" ToolTip="Add Department" OnClick="lnkDeleteDepartment_Click">Delete</asp:LinkButton></li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-9">
                        <div class="row">
                            ...
                            <asp:Panel ID="panelMain" runat="server" Visible="false" CssClass="panelsX"><users:ucUsers ID ="users" runat="server" /></asp:Panel>
                            <asp:Panel ID="panelDpts" runat="server" Visible="false" CssClass="panelsX"><departments:ucDepartments ID ="departments" runat="server" /></asp:Panel>
                            <%--<asp:Panel ID="panelBranches" runat="server" Visible="false" CssClass="panelsX"><branches:ucBranches ID ="branches" runat="server" /></asp:Panel>--%>
                            ...
                            <!---------------------------------------------------Department------------------------------->
                            <asp:Panel ID="panelAddDepartment" runat="server" Visible="false" CssClass="panelsX">
                                <br />
                                <div class="row">
                                    <div class="col-md-3">
                                        <asp:Label ID="Label35" runat="server" Text="Department Name" CssClass="myLabels"></asp:Label>
                                    </div>
                                    <div class="col-md-5">
                                        <asp:TextBox ID="txtDepartmentName" runat="server" Width="100%" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <br />
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <asp:Label ID="Label36" runat="server" Text="Department Code" CssClass="myLabels"></asp:Label>
                                    </div>
                                    <div class="col-md-5">
                                        <asp:TextBox ID="txtDepartmentCode" runat="server" Width="100%" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <br />
                                <div class="row">
                                    <div class="col-md-2 col-lg-offset-4">
                                        <asp:Button ID="btnAdd" runat="server" Text="Add" Width="100%" Visible="true" CssClass="btn btn-success" OnClick="btnAdd_Click" />
                                    </div>
                                    <div class="col-md-2">
                                        <asp:Button ID="Button2" runat="server" Text="Cancel" Width="100%" CssClass="btn btn-default" />
                                    </div>
                                </div>
                            </asp:Panel>


                            <asp:Panel ID="panelDeleteDepartment" runat="server" Visible="false" CssClass="panelsX">

                                <h2 class="">All Departments </h2>
                                <asp:Label ID="Label37" runat="server" Text="Label" Visible="false" ForeColor="Red"></asp:Label>
                                <asp:LinkButton ID="LinkButton4" runat="server" Visible="false">Click Here</asp:LinkButton>
                                <br />


                                <asp:GridView ID="gvdDerpartment" runat="server" CssClass="table table-striped table-bordered templatemo-user-table" OnSelectedIndexChanged="gvdDerpartment_SelectedIndexChanged">
